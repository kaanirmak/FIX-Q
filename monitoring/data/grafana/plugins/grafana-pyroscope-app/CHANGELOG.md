...
* **deps:** align React Router with Grafana runtime ([#1131](https://github.com/grafana/profiles-drilldown/issues/1131)) ([a615b6f](https://github.com/grafana/profiles-drilldown/commit/a615b6f3d90a06cf314c3c613a46e9e16cf4fa0f))
...
* move Profile types and Labels into the panel kebab menu ([#1130](https://github.com/grafana/profiles-drilldown/issues/1130)) ([f71c4ed](https://github.com/grafana/profiles-drilldown/commit/f71c4ed6b6fd6618c437a76ef80c77dca86c8edb))
...
* **security/low/samples/rideshare:** update module go.opentelemetry.io/otel/sdk to v1.45.0 [security] ([#1134](https://github.com/grafana/profiles-drilldown/issues/1134)) ([059ee2d](https://github.com/grafana/profiles-drilldown/commit/059ee2d13a8ba78a64c296a44970b650a41854f3))
...
* profiles-to-traces, ad hoc diff, saved searches, and version fixes ([#1105](https://github.com/grafana/profiles-drilldown/issues/1105)) ([d45d8fc](https://github.com/grafana/profiles-drilldown/commit/d45d8fca2aa55377dd9a1a7c900a0b28cf0cde98))
...
* **deps:** lock file maintenance ([#1127](https://github.com/grafana/profiles-drilldown/issues/1127)) ([e92e118](https://github.com/grafana/profiles-drilldown/commit/e92e118c45538dba5ad68b4936999593dd3953bb))
...
* **UI refresh:** Align plugin UI with Grafana visual design refresh ([#1133](https://github.com/grafana/profiles-drilldown/issues/1133)) ([429d6a6](https://github.com/grafana/profiles-drilldown/commit/429d6a60722d527bdd41d89973d0fa221cf9c284))
